...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "store.minRating": "Minimum Rating",
    "store.priceRange": "Price Range",
    "store.itemsFound": "Items Found",
    "store.sortBy": "Sort By",
    "store.noProducts": "No Products Found",
    "store.noProductsDesc": "Try adjusting your filters or search query.",
    "store.clearFilters": "Clear All Filters",
    "store.loadMore": "Load More Products",
    "store.resultsFor": "Results for",
    "store.exploreCollection": "Explore our premium collection of handpicked items.",
    "store.allCategories": "All Categories",
    "store.type": "Product Type",
    "store.brand": "Brand",
    "store.clear": "Clear",
    "store.benefit1Title": "Free Shipping",
    "store.benefit1Sub": "All orders above ETB 5,000",
    "store.benefit2Title": "Secure Payment",
    "store.benefit2Sub": "Chapa & bank transfers",
    "store.benefit3Title": "24/7 Support",
    "store.benefit3Sub": "WhatsApp & email help",
    "store.benefit4Title": "Easy Returns",
    "store.benefit4Sub": "Hassle-free 30-day returns",
    "sortBy.newest": "Newest",
    "sortBy.popularity": "Popularity",
    "sortBy.rated": "Best Rated",
    "sortBy.lowToHigh": "Price: Low to High",
    "sortBy.highToLow": "Price: High to Low",
    "detail.addToCart": "Add to Cart",
    "detail.reviews": "reviews",
    "common.premiumBrand": "Premium Brand",
  },
  ...
  am: {
    ...
    // Store
    "store.title": "መደብር",
    "store.inStockOnly": "ክምችት ላይ ያለ ብቻ",
    "store.minRating": "ዝቅተኛ ደረጃ",
    "store.priceRange": "የዋጋ ክልል",
    "store.itemsFound": "ምርቶች ተገኝተዋል",
    "store.sortBy": "ደርድር",
    "store.noProducts": "ምንም ምርት አልተገኘም",
    "store.noProductsDesc": "ማጣሪያዎቹን ወይም የፍለጋ ቃሉን ማስተካከል ይሞክሩ።",
    "store.clearFilters": "ሁሉንም ማጣሪያዎች አጽዳ",
    "store.loadMore": "ተጨማሪ ምርቶችን ጫን",
    "store.resultsFor": "ውጤቶች ለ",
    "store.exploreCollection": "የፕሪሚየም ምርቶቻችንን ያስሱ።",
    "store.allCategories": "ሁሉም ምድቦች",
    "store.type": "የምርት ዓይነት",
    "store.brand": "ብራንድ",
    "store.clear": "አጽዳ",
    "store.benefit1Title": "ነጻ ማጓጓዣ",
    "store.benefit1Sub": "ከ ETB 5,000 በላይ ለሁሉም ትዕዛዞች",
    "store.benefit2Title": "ደህንነቱ የተጠበቀ ክፍያ",
    "store.benefit2Sub": "Chapa እና ባንክ ዝውውር",
    "store.benefit3Title": "የ24/7 ድጋፍ",
    "store.benefit3Sub": "WhatsApp እና ኢሜይል ድጋፍ",
    "store.benefit4Title": "ቀላል ተመላሽ",
    "store.benefit4Sub": "ከችግር ነጻ 30 ቀን ተመላሽ",
    "sortBy.newest": "አዲስ",
    "sortBy.popularity": "ተወዳጅነት",
    "sortBy.rated": "ከፍተኛ ደረጃ",
    "sortBy.lowToHigh": "ዋጋ፡ ዝቅ ወደ ከፍ",
    "sortBy.highToLow": "ዋጋ፡ ከፍ ወደ ዝቅ",
    "detail.addToCart": "ወደ ጋሪ ጨምር",
    "detail.reviews": "ግምገማዎች",
    "common.premiumBrand": "ፕሪሚየም ብራንድ",
  },
  ...
  om: {
    ...
    // Store
    "store.title": "Dukaana",
    "store.inStockOnly": "Kan kumni qofa",
    "store.minRating": "Sadarkaa xiqqaa",
    "store.priceRange": "Gatii gidduu",
    "store.itemsFound": "Oomishaaleen argamaniiru",
    "store.sortBy": "Akkaataa",
    "store.noProducts": "Oomishni hin argamne",
    "store.noProductsDesc": "Oomisha kantiin wal simu hin arganne. Maaloo irra deebii yaali.",
    "store.clearFilters": "Hunda haqi",
    "store.loadMore": "Oomishaalee dabalataa",
    "store.resultsFor": "Bu'aa",
    "store.exploreCollection": "Oomishaalee filatamoo keenya ilaali.",
    "store.allCategories": "Ramaddii hunda",
    "store.type": "Gosa oomishaa",
    "store.brand": "Akkaataa",
    "store.clear": "Haqi",
    "store.benefit1Title": "Geejjiba Bilisaa",
    "store.benefit1Sub": "Ajaja ETB 5,000 olii hunda",
    "store.benefit2Title": "Kaffaltii Amansiisaa",
    "store.benefit2Sub": "Chapa fi daddabarsa baankii",
    "store.benefit3Title": "Deeggarsa 24/7",
    "store.benefit3Sub": "WhatsApp fi imeelii deeggarsa",
    "store.benefit4Title": "Deebii Salphaa",
    "store.benefit4Sub": "Guyyaa 30 rakkoo malee deebii",
    "sortBy.newest": "Haaraa",
    "sortBy.popularity": "Baay'ee barbaadamaa",
    "sortBy.rated": "Sadarkaa olaanaa",
    "sortBy.lowToHigh": "Gatii: Xiqqaa irraa gara guddaatti",
    "sortBy.highToLow": "Gatii: Guddaa irraa gara xiqqaatti",
    "detail.addToCart": "Gara Kaartii Ida'i",
    "detail.reviews": "gamaaggama",
    "common.premiumBrand": "Braandii Olaanaa",
  },
};
