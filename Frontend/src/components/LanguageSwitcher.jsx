  ...
  return (
    <div className="relative" ref={switcherRef}>
      <button
        ...
        className={`flex items-center gap-2 border px-2 py-1 rounded text-sm transition ${
          isTransparent
            ? "!bg-transparent bg-white/10 backdrop-blur-sm text-white border-white/20 hover:bg-white/20"
            : "bg-white dark:bg-gray-800 dark:text-white dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700"
        }`}
      >
